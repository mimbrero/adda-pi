...
public class TestEjercicio2 {
	...
	private static List<String> ficheroListaEntrada = List.of("ficheros/ListasOrdenadas.txt");
	private static List<String> etiquetaListaEntrada = List.of("Ordenada");
	...
	private static List<BiFunction<List<Integer>, Integer, Integer>> metodosBusqueda = List.of(Ejercicio2::quickSort);
	
	private static List<String> etiquetaMetodo = List.of("QuickSort");
	...
	public static void generaFicherosDatos(PropiedadesListas p) {
		Resultados.cleanFiles(List.of("ficheros/Lista.txt"));

		FicherosListas.generaFicherosDatos(p,"ficheros/Lista.txt", 0.5);
